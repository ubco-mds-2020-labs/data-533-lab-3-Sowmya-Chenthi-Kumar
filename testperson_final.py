...
def setUp_Class(TestMP):
    self.p = MP.diet()
    self.var = {"protein": 56,"cal": 2500,"fat":83, "sodium":2300, "fiber":38, "carbs":300,"potassium":3000}
    self.test = self.p.default_values("man","nutrient")       
            
def tearDown_Class(TestMP):
    self.p = None
    self.var = None
    self.test = None
